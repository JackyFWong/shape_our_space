...
function drawRoom(x, y, radius) {
  ...
  room.graphics.beginStroke("Black").beginFill("rgba(255, 255, 255, 0.33)").drawCircle(0, 0, radius);
  room.x = x;
  room.y = y;
  room.isRoom = true;
...
function init_canvas() {
  ...
  map.graphics.beginStroke("Black").beginFill("#CAE9FF").rect(0, 0, 1400, 900);
  stage.addChild(map);
